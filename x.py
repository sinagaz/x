###################################################################
#                        Import Module
import json , sys , hashlib , os , time , marshal, getpass, csv
###################################################################
'''
...
def main():
  ...
  try:
	...
	print G+'[2] > Logout Keluar Token'
	print G+'[3] > Terima Semua Pertemanan'
	print G+'[4] > Ambil Semua Email Teman'
	print G+'[5] > Ambil Semua Info TTL(Birthday)'
	print G+'[6] help'
	print G+'[7] Intip Token'
...
def search():
	...
	target = raw_input("[!] Search Name or Id(Enter=All): ")
	target2 = raw_input("[!] Search Email(Enter=All): ")
